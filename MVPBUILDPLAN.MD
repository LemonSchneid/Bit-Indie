...
* **T8-7** Introduce reusable modal/portal utilities. *DoD:* Extract Lightning checkout modal portal setup, body scroll locking, and backdrop scaffolding into a shared modal utility or adopt a framework component; refactor existing checkout overlays to use it; add tests or stories verifying overlay coverage and scroll locking.
