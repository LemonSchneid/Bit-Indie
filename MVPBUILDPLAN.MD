...
* **T8-3** Convert comments router helpers to dependencies. *DoD:* Replace module-level singleton instantiation and manual body parsing with FastAPI dependencies that provide workflow instances and raw-markdown payloads; update routes to consume the dependencies and ensure dependency overrides work cleanly in tests; cover raw-body parsing and dependency override behaviour with automated tests.
