...
* **T8-5** Refactor release note publisher workflow. *DoD:* Extract retry/backoff management, relay instrumentation, and state persistence helpers out of `ReleaseNotePublisher.publish_release_note`; keep queue coordination readable and reusable by other Nostr workflows; add unit tests covering retry scenarios, instrumentation, and failure propagation.
