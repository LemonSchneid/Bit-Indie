...
from bit_indie_api.db.models import Game, ReleaseNotePublishQueue
from bit_indie_api.services.nostr import calculate_event_id, schnorr_sign
...
class ReleaseNotePublisher:
    ...
    def _build_tags(self, *, game: Game, created_at: datetime) -> list[list[str]]:
        ...
        tags.append(["client", "bit-indie-api"])
        tags.append(["t", "bit-indie"])
