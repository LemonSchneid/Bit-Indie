...
from bit_indie_api.schemas.auth import NostrEvent
from bit_indie_api.schemas.review import ReviewRead
...
class PlatformZapSummary(BaseModel):
    """Zap totals supporting the Bit Indie platform infrastructure."""
