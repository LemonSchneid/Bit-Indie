...
const PRESET_SAT_AMOUNTS = [100, 500, 1000, 5000, 10_000];
...
export function ZapButton({
  ...
  return (
    <div ref={containerRef} className={`relative ${className ?? ""}`}>
      ...
      {isMenuOpen ? (
        <div className="absolute right-0 z-20 mt-2 w-72 rounded-2xl border border-amber-400/40 bg-slate-950/95 p-4 text-xs text-slate-200 shadow-xl shadow-amber-500/20">
